...
app.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: [
      ...
      'POST   /api/items                   (store JWT · adds to your own products)',
      'PATCH  /api/items/:id               (store JWT · your own products only)',
      'DELETE /api/items/:id               (store JWT · your own products only)',
      'POST   /api/orders',
      'GET    /api/orders',
      'GET    /api/orders/:id',
      ...
      'PATCH  /api/supermarkets/me { name?, vat_number?, pin?, till_number? } (receipt identity)',
